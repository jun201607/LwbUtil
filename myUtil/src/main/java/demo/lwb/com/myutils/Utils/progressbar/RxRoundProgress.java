package demo.lwb.com.myutils.Utils.progressbar;
...
//		canvas.drawRect(0, 0, getWidth(), getWidth(), paint);// 正方形
        ...
        //右边最大值
        canvas.drawText(StringUtil.format2Decimals(getProgress() + ""), (centre + 90) - moneyPaint.measureText(StringUtil.format2Decimals(getProgress() + "")) / 2 - 15, centre + 105, moneyPaint);
        //}
        //右边最大值
        canvas.drawText("元", (centre + 90) + moneyPaint.measureText(StringUtil.format2Decimals(getProgress() + "")) / 2 - 10, centre + 105, moneyDPaint);
        //根据进度画圆弧
