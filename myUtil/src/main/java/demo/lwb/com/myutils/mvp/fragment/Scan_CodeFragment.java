...
import demo.lwb.com.myutils.Utils.RxTool.RxBeepTool;
import demo.lwb.com.myutils.Utils.RxTool.RxConstants;
import demo.lwb.com.myutils.Utils.RxTool.RxPhotoTool;
import demo.lwb.com.myutils.Utils.RxTool.RxSPTool;
import demo.lwb.com.myutils.Utils.StringUtil;
import demo.lwb.com.myutils.Utils.camera.CameraManager;
import demo.lwb.com.myutils.Utils.camera.InactivityTimer;
import demo.lwb.com.myutils.Utils.camera.OnRxScanerListener;
import demo.lwb.com.myutils.Utils.camera.PlanarYUVLuminanceSource;
import demo.lwb.com.myutils.Utils.camera.RxQrBarTool;
...
public class Scan_CodeFragment extends BaseFragment {
    ...
    private void initPermission() {
        if (PermissionUtils.checkPermissionsGroup(getActivity(), new String[]{PermissionUtils.CAMERA, PermissionUtils.WRITE_EXTERNAL_STORAGE})) {
            PermissionUtils.requestPermissions(getActivity(), new String[]{PermissionUtils.CAMERA, PermissionUtils.WRITE_EXTERNAL_STORAGE}, RequestPermiss);
        }
    }
    ...
    private void initDialogResult(Result result) {
        ...
        RxSPTool.putContent(getContext(), RxConstants.SP_SCAN_CODE, stringToInt(RxSPTool.getContent(getActivity(), RxConstants.SP_SCAN_CODE)) + 1 + "");
    }
    /**
