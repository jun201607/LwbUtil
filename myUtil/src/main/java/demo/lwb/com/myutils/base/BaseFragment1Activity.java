...
import demo.lwb.com.myutils.Utils.EditTextManager;
import demo.lwb.com.myutils.Utils.StringUtil;
import demo.lwb.com.myutils.interfaces.OnFinishListener;
import demo.lwb.com.myutils.manager.FramentManages;
import demo.lwb.com.myutils.manager.ThreadManager;
...
public abstract class BaseFragment1Activity extends RxFragmentActivity implements OnGestureListener, OnTouchListener,OnFinishListener {
	 ...
	 */
	protected BaseFragment1Activity context = null;
	/**
	 * 在onCreate方法中赋值，不能在子Activity中创建
	 */
