...
public class FloatingActionFragment_ViewBinding implements Unbinder {
  ...
  public FloatingActionFragment_ViewBinding(final FloatingActionFragment target, View source) {
    ...
    View view;
    view = Utils.findRequiredView(source, 2131755291, "field 'floatingActionButton' and method 'onViewClicked'");
    target.floatingActionButton = Utils.castView(view, 2131755291, "field 'floatingActionButton'", FloatingActionButton.class);
    view2131755291 = view;
