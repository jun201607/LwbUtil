...
public class AnimationTextViewFragment_ViewBinding implements Unbinder {
  ...
  public AnimationTextViewFragment_ViewBinding(AnimationTextViewFragment target, View source) {
    ...
    target.tvMatchButton = Utils.findRequiredViewAsType(source, 2131755237, "field 'tvMatchButton'", MatchButton.class);
    target.tv_button1 = Utils.findRequiredViewAsType(source, 2131755239, "field 'tv_button1'", Button.class);
    target.tvMatchTextView = Utils.findRequiredViewAsType(source, 2131755236, "field 'tvMatchTextView'", MatchTextView.class);
    target.tv_button = Utils.findRequiredViewAsType(source, 2131755238, "field 'tv_button'", Button.class);
  }
