...
public class BottomNavigationBarFragment_ViewBinding implements Unbinder {
  ...
  public BottomNavigationBarFragment_ViewBinding(BottomNavigationBarFragment target, View source) {
    ...
    target.bottomNavigationBar = Utils.findRequiredViewAsType(source, 2131755240, "field 'bottomNavigationBar'", BottomNavigationBar.class);
    target.bottomNavigationView = Utils.findRequiredViewAsType(source, 2131755241, "field 'bottomNavigationView'", BottomNavigationView.class);
  }
