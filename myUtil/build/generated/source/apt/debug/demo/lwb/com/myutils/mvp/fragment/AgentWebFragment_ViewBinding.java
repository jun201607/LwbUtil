...
public class AgentWebFragment_ViewBinding implements Unbinder {
  ...
  public AgentWebFragment_ViewBinding(final AgentWebFragment target, View source) {
    ...
    View view;
    target.llAgentview = Utils.findRequiredViewAsType(source, 2131755229, "field 'llAgentview'", LinearLayout.class);
    view = Utils.findRequiredView(source, 2131755230, "field 'btnClear' and method 'onViewClicked'");
    target.btnClear = Utils.castView(view, 2131755230, "field 'btnClear'", Button.class);
    view2131755230 = view;
