...
public class EventBusFragment_ViewBinding implements Unbinder {
  ...
  public EventBusFragment_ViewBinding(EventBusFragment target, View source) {
    ...
    target.btnEventBus = Utils.findRequiredViewAsType(source, 2131755247, "field 'btnEventBus'", Button.class);
    target.tvEventBus = Utils.findRequiredViewAsType(source, 2131755248, "field 'tvEventBus'", TextView.class);
  }
